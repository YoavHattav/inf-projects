...
static int ActionFunc(void *tree_data, void *user_data)
{
    UNUSED(user_data);
...
static void BSTTest1()
{
    ...
    it1 = BSTNext(it1);
    RUN_TEST(25 == *(int *)(it1->data), "next1");
    it1 = BSTPrev(it1);
    RUN_TEST(20 == *(int *)(it1->data), "next1");
    it3 = it1;
    it1 = BSTPrev(it1);
    it1 = BSTPrev(it1);
    it2 = it1;
    it1 = BSTPrev(it1);
    RUN_TEST(3 == *(int *)(it1->data), "next1");
    
    BSTRemove(it1);
    RUN_TEST(NULL == it2->child[0], "remove1");
    BSTRemove(it2);
    RUN_TEST(15 == *(int*)(it3->child[0]->data), "remove1");
    BSTRemove(it3);
    RUN_TEST(25 == *(int*)(tree->dummy.child[0]->data), "remove1");
    BSTDestroy(tree);
...
static void BSTTest2()
{
    ...
    RUN_TEST(3 == *(int*)((BSTBegin(tree))->data), "begin2");
    BSTRemove(BSTBegin(tree));
    
    RUN_TEST(10 == *(int*)((BSTBegin(tree))->data), "begin2");
    BSTRemove(BSTBegin(tree));

    RUN_TEST(15 == *(int*)((BSTBegin(tree))->data), "begin2");  
    
    RUN_TEST(35 == *(int*)(BSTPrev(BSTEnd(tree)))->data, "end2");
    BSTRemove(BSTPrev(BSTEnd(tree)));
    
    RUN_TEST(30 == *(int*)(BSTPrev(BSTEnd(tree)))->data, "end2");
    BSTRemove(it2);
    
    RUN_TEST(30 == *(int*)(BSTPrev(BSTEnd(tree)))->data, "end2");
    RUN_TEST(15 == *(int*)(BSTBegin(tree))->data, "end2");
    BSTDestroy(tree);
...
static void BSTTest3()
{
    ...
    it1 = BSTBegin(tree);
    it1 = BSTNext(it1);
    RUN_TEST(10 == *(int*)(it1->data), "next3");
    it2 = BSTFind(tree, &x3);
    RUN_TEST(30 == *(int*)(it2->data), "next3");
    printf("For Each:\n"); 
